...
void runCalibrationStandard(TString lInputFileName = "results/AR_544122_glauberNBD_ancestorMode2_hFT0C_BCs.root", double anchorPointPercentage = 90.f, Bool_t globalNormalisation = kFALSE)
{
