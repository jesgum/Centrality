...
void drawSummaryPlotsCrossCheck( TString lInputFileName = "AnalysisResultsLHC24ar_glauberNBD_ancestorMode2_isCollision0.root",
                       TString lCalibFileName = "AnalysisResultsLHC24ar_glauberNBD_ancestorMode2_isCollision0.root")
{


  TString lXaxisTitle = "FT0C Amplitude";
  TString lRunNumber = "544122";
  TFile *file = new TFile(lInputFileName.Data(), "READ");
  file->ls();

  TFile *file2 = new TFile(lCalibFileName.Data(), "READ");
  file2->ls();
...
//  TH1F *hRawStitched = (TH1F*) file2->Get("hCalib");
  ...
  // TH1F *hGlauberFunctionHyperFine = (TH1F*) file->Get("hGlauberFine");
