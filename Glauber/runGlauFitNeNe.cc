...
void runGlauFitNeNe(TString lInputFileName = "AnalysisResults-25ae.root", TString type = "hNPVContributors", TString histogramName = "hFT0C_BCs", TString wagon = "", TString nuclearProfile = "Ne", float omega = 0.3){
  cout<<"Starting!"<<endl;
